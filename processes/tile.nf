...
process calculate_tile_size{
    ...
    """
    tile_shape=(`python $binDir/calculateOptimalTileSize.py $max_x_resolution $max_y_resolution  params.utils.target_tile_size_x params.utils.target_tile_size_y`)
